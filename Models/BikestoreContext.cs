...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-91MF13G;Database=Bikestore;Integrated Security=true;TrustServerCertificate=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasIndex(e => e.Phone, "ix_cust_phone");
            ...
            modelBuilder.Entity<EmployeeAudit>(entity =>
            {
                entity.HasKey(e => e.AuditId)
                    .HasName("PK__Employee__5AF33E3356C3B071");
                ...
                entity.Property(e => e.OldDeptId).HasColumnName("old_dept_id");

                entity.Property(e => e.OldGender)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("old_gender");
            ...
            modelBuilder.Entity<OrderItem>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ItemId })
                    .HasName("PK__order_it__837942D42487618E");
            ...
            modelBuilder.Entity<Staff>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164BA22C5E9")
                    .IsUnique();
            ...
            modelBuilder.Entity<Stock>(entity =>
            {
                entity.HasKey(e => new { e.StoreId, e.ProductId })
                    .HasName("PK__stocks__E68284D3EBFB6ED9");
